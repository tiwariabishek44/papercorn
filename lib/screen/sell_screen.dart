...
import '../widget/account_scree_appbar.dart';
...
class _SellScreenState extends State<SellScreen> {
  ...
  TextEditingController gcasController = TextEditingController();
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFieldWidget(
                                ...
                                controller: gcasController,
                                obscureText: false,
                                hintText: "Enter the G-cash"),
                            const Text(
                              "Discount",
                              style: TextStyle(
                      ...
                      CustomMainButton(
                          ...
                          onPressed: () async {
                            String output = await CloudFirestoreClass()
                                ...
                                gcash: gcasController.text,
                                discount: keysForDiscount[selected - 1],
                                sellerName: "Twinstech pvt ltd.",
